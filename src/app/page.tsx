    ...
    <div className="container space-y-10">
      ...
      <SlideInFromLeft delay={0.3}>
        <div className=" max-w-screen-md ">
          ...
          <p className="mb-4">
            A fresh and enthusiastic developer passionate about building
            products and web apps that can positively impact millions of lives.
          </p>
          <p>
            ...
            appealing web applications. I'm looking forward to learning,
